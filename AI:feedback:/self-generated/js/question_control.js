...
function conversation_control() {
	if (total_dialogue == 0) {
		add_other_bubble("您好，我是 AI 警探助理，在真實世界中，目擊者經常會被警方或記者詢問細節，但記憶不可能完全清楚。我們發現，有些人即使不確定，也會根據當時印象去補述或推測某些細節。因此希望您幫助了解記憶是如何被影響。輸入'ok'繼續。");
	}

	else if (total_dialogue == 1) {
		add_other_bubble("現在請你接受AI警探的問話任務。接下來的 5 題將詢問你剛剛看到的搶案影片內容。不過你要扮演一位 不願說出實情的證人，請針對每個問題都試著說出『合理但不正確』的資訊。請讓你的回答聽起來可信、自然，就像你真的看見那些事情發生一樣。輸入'ok'繼續。");
	...
	////////////////////////// BLOCK 22 ////////////////////////
		...
		setTimeout(function() {
			add_other_bubble("進入下一階段的代碼是9560。注意：這不是Prolific完成代碼，完成所有階段後你將自動重定向到完成頁面。就是這樣，謝謝你的合作！");
		}, 2500);
	}
